    ...
    controls: [
        {
            ...
            controls: [
                ...
                },
                {
                    ...
                    responsive: false,
                    render: (value: any, onChange: any) => (
                        <NumberControl label="Total Limit" value={value ?? 8} onChange={onChange} min={3} max={30} />
                    ),
                },
                {
                    name: "columnsDesktop",
                ...
                },
                {
                    ...
                    responsive: false,
                    render: (value: any, onChange: any) => (
                        <Toggle label="Show Play Icon" value={value !== "false"} onChange={(v: boolean) => onChange(v ? "true" : "false")} />
                    ),
                },
                {
                    name: "showDate",
